...
//
//  Created by Ruslan Alekyan on 13.03.2022.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var lastTimeUpdate: TimeInterval?
    ...
    func updateSkater() {
        ...
        let maxRotation = CGFloat(GLKMathDegreesToRadians(100.0))
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if let lastTimeStamp = lastTimeUpdate {
